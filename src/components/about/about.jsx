                            ...
                            <div className="personal-info padd-15">
                                <div className="row">
                                    <div className="info-item padd-15">
                                        <p>Birthday : <span>30 dec 2006</span></p>
                                    </div>
                                    <div className="info-item padd-15">
                                        <p>Address : <span>kg 800 street</span></p>
                                    </div>
                                    <div className="info-item padd-15">
                                        <p>Instagram : <span><a href="https://www.instagram.com/_ngoma_301/" target="blank" rel='' title="Click Here to Get On Instagram Page" >_ngoma_301</a></span></p>
                                    </div>
                                    <div className="info-item padd-15">
